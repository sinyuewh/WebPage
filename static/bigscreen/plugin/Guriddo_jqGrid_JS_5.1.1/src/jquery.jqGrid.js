...
(function (factory) {
        ...
        return this.each(function () {
                    ...
                    if (this.resizing) {
                        ...
                        if (events) {
                            ...
                            /*if ($.isFunction(p.resizeStop)) { p.resizeStop.call(ts, nw, idx); }
                                ...
                                $("#gbox_"+ts.id+' .ui-corner-top').css("width",($("#gbox_"+ts.id+" .ui-common-table").width()>$("#gbox_"+ts.id+' .ui-jqgrid-view').width()?$("#gbox_"+ts.id+" .ui-common-table").width():$("#gbox_"+ts.id+' .ui-jqgrid-view').width())+'px');
                                $("#gbox_"+ts.id+' .ui-jqgrid-view').css("overflow-x","hidden");
                                $('#'+ts.id).parent().parent().css("width",$("#gbox_"+ts.id+" .ui-common-table").width()+'px');
                            }*/
                        }
                    }
                    this.curGbox = null;
            ...
            updatepager = function (rn, dnd) {
                ...
                if (pgboxes) {
                    ...
                    if (ts.p.pginput === true) {
                        ...
                        $('.ui-pg-button-i', pgboxes).closest('li').remove();
                        ...
                        if (last > 5) {
                            ...
                            if (cp <5) {
                                ...
                                for (var _i = 0; _i < 5 ; _i++) {
                                    if(flag==_i+1) {
                                        ipager += "<li style='background-color:#7DA2FF;'><a href='javascript:void(0);' class='ui-pg-button-i' style='background-color:#7DA2FF;color:white'>" + (cp + _i) + "</a></li>";
                                    }
                                    else{
                                        ipager += "<li><a href='javascript:void(0);' class='ui-pg-button-i'>" + (cp + _i) + "</a></li>";
                                    }
                                }
                            } else if (cp >= last - 5) {
                               ...
                               // cp = last - 5;
                                ...
                                ipager += "<li><a href='javascript:void(0);' class='ui-pg-button-i'>" + (cp - 4) + "</a></li>";
                                ipager += "<li><a href='javascript:void(0);' class='ui-pg-button-i'>" + (cp - 3) + "</a></li>";
                                ipager += "<li><a href='javascript:void(0);' class='ui-pg-button-i'>" + (cp - 2) + "</a></li>";
                                ipager += "<li><a href='javascript:void(0);' class='ui-pg-button-i'>" + (cp-1) + "</a></li>";
                                ipager += "<li style='background-color:#7DA2FF;'><a href='javascript:void(0);' class='ui-pg-button-i' style='background-color:#7DA2FF;color:white;'>" + (cp ) + "</a></li>";
                            
                            } else {
                                ipager += "<li><a href='javascript:void(0);' class='ui-pg-button-i'>" + (cp - 2) + "</a></li>";
                                ipager += "<li><a href='javascript:void(0);' class='ui-pg-button-i'>" + (cp - 1) + "</a></li>";
                                ipager += "<li style='background-color:#7DA2FF;'><a href='javascript:void(0);' class='ui-pg-button-i' style='background-color:#7DA2FF;color:white;'>" + (cp - 0) + "</a></li>";
                                ipager += "<li><a href='javascript:void(0);' class='ui-pg-button-i'>" + (cp + 1) + "</a></li>";
                                ipager += "<li><a href='javascript:void(0);' class='ui-pg-button-i'>" + (cp + 2) + "</a></li>";
                            }
                        } else {
                            ...
                            for (var _i = 0; _i < last ; _i++) {
                                if(cp==_i+1){
                                    ipager += "<li style='background-color:#7DA2FF;'><a href='javascript:void(0);' class='ui-pg-button-i' style='background-color:#7DA2FF;color:white;'>" + (_i+1) + "</a></li>";
                                }
                                else {
                                    ipager += "<li><a href='javascript:void(0);' class='ui-pg-button-i'>" + (_i + 1) + "</a></li>";
                                }
                            }
                        }
                        ...
                        $('#newPager', pgboxes).after(ipager);
                        $('.ui-pg-button-i', pgboxes).click(function () {
                           
                            ts.p.page = ($(this).text() > 0) ? $(this).text() : ts.p.page;
                            var cp = intNum(ts.p.page, 1) + 1;
                            populate();
                           // alert(cp)
                            return false;
                        })
            ...
            populate = function (npage) {
                if (!ts.grid.hDiv.loading) {
                    ...
                    if(ts.p.page>(ts.p.lastpage!=0?ts.p.lastpage:1)){
                        window.jqGridUtils.POPALERT("输入页码过大，已跳到最后一页！", 1,3);
                    }
                    ts.p.page=(ts.p.page>(ts.p.lastpage!=0?ts.p.lastpage:1)?ts.p.lastpage:ts.p.page);
            ...
            setPager = function (pgid, tp) {
                ...
                pginp = "",
                pgl = "<ul class='ec-pagination ec-pagination-sm dt-grid-pager-button' style='float:left ;margin-left:16%;'>", //<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",
                str = "", pgcnt, lft, cent, rgt, twd, tdw, i, uinfo, ipager,
                ...
                ts.p.recordtext="共<span style='color:red;'>{2}</span> 条数据";
                if (ts.p.viewrecords === true) { uinfo = "<span class='dt-grid-pager-status text-primary ui-paging-info'></span>"; }

                //if (ts.p.pginput === true) { pginp = $.jgrid.format(ts.p.pgtext || "", "", "<span id='sp_1_" + $.jgrid.jqID(pgid) + "'></span>"); }
                if (ts.p.pginput === true) {
                    var pages= Math.ceil(ts.p.data.length/ts.p.rowNum);

                    /*pginp = $.jgrid.template($.jgrid.getRegional(ts, "defaults.pgtext", ts.p.pgtext) || "", "跳转到第 <select class='ui-pg-input ec-form-field ec-radius ec-input-sm'   style='display: inline; width:auto !important;background-color:transparent;border: 1px solid #cbcbcb;margin-right:5px;' role='textbox'> "+options+'页', " <span id='sp_1_" + $.jgrid.jqID(pgid) + "'></span>");*/
                    pginp = $.jgrid.template("{0}", "<span style='margin-left: 5%; font-size: 14px;'>跳转到第 <input class='ui-pg-input ec-form-field ec-radius ec-input-sm'   " +
                        ...
                        " role='textbox'/> "+'页</span>', " <span id='sp_1_" + $.jgrid.jqID(pgid) + "'></span>");
                    /*pginp = $.jgrid.template($.jgrid.getRegional(ts, "defaults.pgtext", ts.p.pgtext) || "", "第 <input class='ui-pg-input ec-form-field ec-radius ec-input-sm' type='text' size='2' maxlength='10'  style='display: inline; width: 3rem;' value='0' role='textbox'/> 页，", " <span id='sp_1_" + $.jgrid.jqID(pgid) + "'></span>");*/
                }
                 //todo
                ...
                if (ts.p.rowList.length > 0) {
                    /*title=\"" + ($.jgrid.getRegional(ts, "defaults.pgrecs", ts.p.pgrecs) || "") + "\"*/
                    str =pginp+uinfo+ "   <span style='    margin-right:5%;'>每页显示<select  class='ec-form-field ec-radius ec-input-sm  change-page-size ' "+
                        + getstyle(stylemodule, 'pgSelectBox', false, 'ui-pg-selbox') + " role=\"listbox\" >";
                    var strnm;
                ...
                if (ts.p.pgbuttons === true) {
                    ...
                    //ipager = '<span id="newPager"></span>';
                    pgl += "<li><a href='javascript:void(0);' class='ui-pg-button' id='" + po[0] + "' ><i class='ec-icon-angle-double-left'></i></a></li>";
                    pgl += "<li id='newPager'><a href='javascript:void(0);' class='ui-pg-button' id='" + po[1] + "' ><i class='ec-icon-angle-left'></i></a></li>";
                   // pgl += ipager;
                    pgl += "<li><a href='javascript:void(0);' class='ui-pg-button' id='" + po[2] + "' ><i class='ec-icon-angle-right'></i></a></li>";
                    pgl += "<li><a href='javascript:void(0);' class='ui-pg-button' id='" + po[3] + "' ><i class='ec-icon-angle-double-right'></i></a></li>";
                } else if (pginp !== "") {
                    pgl += pginp;
                }
                ...
                //$("#" + pgid + "_" + ts.p.pagerpos, "#" + pgcnt).append(pgl);




                $("#" + $.jgrid.jqID(pgid)).append("<span id='" + pgcnt + "' class='dt-grid-pager'>" + pgl + str + "</span><div class='clearfix'></div>");
                ...
                ts.p._nvtd[1] = 0;
                pgl = null;
                $('.change-page-size', "#" + pgcnt).bind('change', function () {
                    if (!clearVals('records', this)) { return false; }
                    ts.p.rowNum = this.value;
                    ts.p.page =(ts.p.page>Math.ceil(ts.p.data.length/ts.p.rowNum)?1:ts.p.page); /*Math.round(ts.p.rowNum * (ts.p.page - 1) / this.value - 0.5) + 1*/;
                    ts.p.lastpage= ts.p.page;
                ...
                if (ts.p.pginput === true) {
                    $("#" + pgcnt).on('keypress', 'input.ui-pg-input', function (e) {
                        ...
                        if (key === 13) {
                            ...
                            if(isNaN($(this).val())){
                                window.jqGridUtils.POPALERT("输入错误，请仔细检查！", 1,3);
                            }
                            else {
            ...
            sortData = function (index, idxcol, reload, sor, obj) {
                ...
                else{ts.p.page=ts.p.postData.page}
                if (ts.p.datatype === "local") {
    ...
    */
    ...
    $.fn.fmatter.checkbox = function (cval, pts) {
    ...
    $.fn.fmatter.actions = function (cellval, opts) {
        ...
        if (op.editformbutton) {
            ...
            str += "<div title='" + nav.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit ec-btn ec-btn-xs ec-btn-default' " + ocl + "><span class='" + common.icon_base + " " + classes.icon_edit + "'></span>&nbsp;" + nav.edittitle + "</div>";
        ...
        if (op.delbutton) {
            ...
            str += "<div title='" + nav.deltitle + "' style='float:left;margin-left:5px;' class='ui-pg-div ui-inline-del ec-btn ec-btn-xs ec-btn-danger' " + ocl + "><span class='" + common.icon_base + " " + classes.icon_del + "'></span>&nbsp;" + nav.deltitle + "</div>";
        }
        ocl = "id='jSaveButton_" + rowid + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'save'); " + hover;
        str += "<div title='" + nav.savetitle + "' style='float:left;display:none' class='ui-pg-div ui-inline-save ec-btn ec-btn-xs ec-btn-warning' " + ocl + "><span class='" + common.icon_base + " " + classes.icon_save + "'></span>&nbsp;" + nav.savetitle + "</div>";
        ocl = "id='jCancelButton_" + rowid + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'cancel'); " + hover;
        str += "<div title='" + nav.canceltitle + "' style='float:left;display:none;margin-left:5px;' class='ui-pg-div ui-inline-cancel ec-btn ec-btn-xs ec-btn-default' " + ocl + "><span class='" + common.icon_base + " " + classes.icon_cancel + "'></span>&nbsp;" + nav.canceltitle + "</div>";
        return "<div class='jq-control-btn'>" + str + "</div>";
    };
    ...
    window.jqGridUtils = {
        ...
        POPALERT: function (msg, color,tips) {
            $(".slidedown").remove();
            var _c;
            var _icon;
            ...
            if(color==1){
                _c = 'ec-alert-success';
                _icon='<i class="ex-mess-ok">'+'</i>';
            }
            if(color==2){
                _c = 'ec-alert-warning';
                _icon='<i class="ex-mess-warn">'+'</i>';
            }
            if(color==3){
                _c = 'ec-alert-danger';
                _icon='<i class="ex-mess-del">'+'</i>';
            }
            var _alertHtml;
            if(tips==1){
                _icon='<i class="ex-mess-ok tips">'+'</i>';
                _alertHtml = '<div class="ec-alert ' + _c + ' slidedown in ex-tips-box">';
                _alertHtml+=_icon;
                _alertHtml += '<span class="ex-deviceinfo-alert-span">'+msg+'</span>';
                _alertHtml += '</div>';
            }else if(tips==2) {
                _icon='<i class="ex-mess-del tips">'+'</i>';
                _alertHtml = '<div class="ec-alert ' + _c + ' slidedown in ex-tips-box">';
                _alertHtml+=_icon;
                _alertHtml += '<span class="ex-deviceinfo-alert-span">'+msg+'</span>';
                _alertHtml += '</div>';
            }else {
                _alertHtml = '<div class="ec-alert ' + _c + ' slidedown in">';
                _alertHtml+=_icon;
                _alertHtml += '<span style="padding-left: 22px" class="ex-deviceinfo-alert-span">'+msg+'</span>' +
                    '<em class="ex-mess-close">'+'</em>';
                _alertHtml += '</div>';
            }
